...
async function callOllama(prompt: string): Promise<string> {
  ...
  try {
    ...
    console.log('Ollama response:', data.response); // Debug log
...
export async function POST(req: NextRequest) {
  ...
  console.log('Received prompt from frontend:', prompt); // Debug log
